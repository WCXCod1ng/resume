...
\begin{itemize}[parsep=0.5ex]
  \item 掌握C++11，并熟悉C++14/17/20新特性；了解Python、Golang、Java
  \item 熟悉Linux环境下的Socket编程、高性能网络开发模型
  \item 熟悉Redis的基本用法，理解其常见数据类型、持久化、分布式锁等；掌握MySQL的增删改查操作，理解事务、索引、锁机制等
...
\begin{itemize}
  ...
  \item 设计并实现了基于Radix Tree的HTTP路由分发机制，在路径查找时间复杂度上优于传统的正则匹配或哈希表查找；实现了基于责任链模式的中间件机制，支持全局与路由组级别的切面处理（日志、鉴权等）；集成MySQL连接池和Redis连接池。
